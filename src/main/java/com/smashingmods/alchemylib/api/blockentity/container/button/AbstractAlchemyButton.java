...
public abstract class AbstractAlchemyButton extends Button {
    ...
    public AbstractAlchemyButton(AbstractProcessingScreen<?> pParent, AbstractProcessingBlockEntity pBlockEntity, Button.OnPress pOnPress) {
        this(0, 0, 20, 20, TextComponent.EMPTY, pParent, pBlockEntity, pOnPress);
    }

    public AbstractAlchemyButton(int pX, int pY, int pWidth, int pHeight, Component pComponent, AbstractProcessingScreen<?> pParent, AbstractProcessingBlockEntity pBlockEntity, Button.OnPress pOnPress) {
