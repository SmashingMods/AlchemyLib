...
public abstract class AbstractAlchemyButton extends Button {
    ...
    public AbstractAlchemyButton(AbstractProcessingScreen<?> pParent, Button.OnPress pOnPress) {
        this(0, 0, 20, 20, TextComponent.EMPTY, pParent, pOnPress);
    }
     ...
     * @param pComponent {@link Component} for displaying on the button. By default, this is set to an empty string and no text is displayed.
     ...
     */
    public AbstractAlchemyButton(int pX, int pY, int pWidth, int pHeight, Component pComponent, AbstractProcessingScreen<?> pParent, Button.OnPress pOnPress) {
